    ...
    <div className={s.container}>
        ...
        <div className={s.navContentCenter}>
            <div className={s.customButton}
                style={{backgroundColor:`${location.pathname==='/home' ?'#1596f1' :''}`,
            ...
            <div className={s.customButton}
                style={{backgroundColor:`${location.pathname==='/projects' ?'#1596f1' :''}`,
            ...
            <div className={s.customButton}
                style={{backgroundColor:`${location.pathname==='/about' ?'#1596f1' :''}`,

                    ...
                    <div className={s.info}>
                      ...
                      <div className={s.text}>
                        ...
                        <p>
                          ...
                          interested in Node, React, C++, Startups, games and
                          music 🕹️🎧
                        </p>
                      </div>
                    </div>
                ...
                <div className={s.x1}>
                  <div
                    ...
                    style={{
                      color: "white",
                      background:
                        "linear-gradient(to top right, #1761fe, #777aec)",
                    }}
                  >
                    <div className={s.text}>
                ...
                <div className={s.x2}>
                  <div
                    ...
                    style={{
                      color: "white",
                      background: `linear-gradient(to top right, ${
                        !isDarkMode ? "#5acbf5, #55e9cb" : "#2a6b6b,#4fba4d"
                      })`,
                    }}
                  >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(to top, ${
                      !isDarkMode ? "#ddc3fc, #90c5fb" : "#521638,#004d79"
                    })`,
                  }}
                >
                  <div className={s.text}>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to bottom, #fd4f62, #fd375b)",
                      }}
                    >
                      <div
                        style={{
